...
chmod +x "$ROOT_DIR/scripts/hooks/post-checkout"
chmod +x "$ROOT_DIR/scripts/hooks/prepare-commit-msg"
...
echo "[hooks] Beads hook integration is installed for commit, push, merge, checkout, and commit-message preparation."
