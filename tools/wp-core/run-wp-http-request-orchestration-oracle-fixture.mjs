...
const ISSUE = {
  id: "wordpresshx-l76.18.33",
  external_ref: "WPHX-312.46",
  title: "WPHX-312.46 - Add WP_Http request orchestration oracle fixture"
};
const RECORDED_AT = "2026-06-27T00:00:00.000Z";
const UPSTREAM_ROOT = "../wordpress-develop";
const RUNNER = "tools/wp-core/run-wp-http-request-orchestration-oracle-fixture.mjs";
const OUT_ROOT = "build/wp-core/wphx-312-46";
const ORACLE_ROOT = `${OUT_ROOT}/oracle`;
const CANDIDATE_ROOT = `${OUT_ROOT}/candidate`;
const PROBE = `${OUT_ROOT}/probe.php`;
const OUT = "manifests/wp-core/wphx-312-46-wp-http-request-orchestration-oracle-fixture.v1.json";
const OWNERSHIP = "manifests/ownership/wphx-312-46-wp-http-request-orchestration-oracle-fixture.v1.json";
const RECEIPT = "receipts/wp-core/wphx-312-46-wp-http-request-orchestration-oracle-fixture.v1.json";
...
function ownershipManifest(manifestSha) {
  return {
    ...
    manifest_id: "ownership:wp-core/wp-http-request-orchestration-oracle-fixture",
    issue: {
      id: ISSUE.id,
    ...
    unit: {
      ...
      name: "WP_Http request orchestration behavior",
      area:
      ...
      public_contract:
        "This fixture executes copied WordPress 7.0 WP_Http request orchestration in isolated PHP CLI probes. It observes default/filter argument construction, preemptive responses, invalid/blocked request errors, streaming path checks, headers/cookies/SSL option handoff, Requests exception conversion, nonblocking response shape, debug actions, and response filtering through a deterministic Requests boundary without claiming live Requests network I/O, real DNS/proxy/TLS behavior, transport execution, redirect following, installed distribution behavior, or generated public PHP ownership."
    },
    ownership_state: "oracle_mirror_behavior_fixture",
    bridge: {
      exists: true,
      kind: "copied-oracle-public-php-with-stubbed-requests-boundary",
      removal_gate:
    ...
    verification: {
      oracle_commands: [
        "npm run wp:core:wphx-312-wp-http-request-orchestration-oracle-fixture",
        "npm run wp:core:wphx-312-wp-http-request-orchestration-oracle-fixture:check",
        "npm run receipts:validate",
        "npm run beads:validate"
      ],
      receipt_refs: ["receipt:wphx-312-46-wp-http-request-orchestration-oracle-fixture"],
...
async function main() {
  ...
  const manifest = {
    schema: "wphx.wp-core-wp-http-request-orchestration-oracle-fixture.v1",
  ...
  const receipt = {
    ...
    id: "receipt:wphx-312-46-wp-http-request-orchestration-oracle-fixture",
    issue: ISSUE,
    recorded_at: RECORDED_AT,
    artifacts: [
      { path: OUT, role: "WP_Http request orchestration oracle-source-mirror fixture manifest" },
      { path: OWNERSHIP, role: "ownership manifest for copied-oracle WP_Http request orchestration boundary" },
