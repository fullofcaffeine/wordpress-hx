...
async function main() {
  ...
  const manifest = {
    ...
    candidate: {
      ...
      promoted_behavior:
        "Only the WP_Http::request stream destination error branch decision over PHP-owned wp_is_writable evaluation is emitted by generated Haxe PHP. The surrounding public method body is now emitted by structured WPHX PHP Adapter IR as a bounded original-path adapter and remains PHP-owned request orchestration, not full request behavior ownership."
    },
    fixture: {
      cases: CASES,
