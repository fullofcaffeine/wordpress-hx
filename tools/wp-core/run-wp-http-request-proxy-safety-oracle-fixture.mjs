...
const ISSUE = {
  id: "wordpresshx-l76.18.36",
  external_ref: "WPHX-312.49",
  title: "WPHX-312.49 - Add WP_Http request proxy/safety option oracle fixture"
};
const RECORDED_AT = "2026-06-27T00:00:00.000Z";
const UPSTREAM_ROOT = "../wordpress-develop";
const RUNNER = "tools/wp-core/run-wp-http-request-proxy-safety-oracle-fixture.mjs";
const OUT_ROOT = "build/wp-core/wphx-312-49";
const ORACLE_ROOT = `${OUT_ROOT}/oracle`;
const CANDIDATE_ROOT = `${OUT_ROOT}/candidate`;
const PROBE = `${OUT_ROOT}/probe.php`;
const OUT = "manifests/wp-core/wphx-312-49-wp-http-request-proxy-safety-oracle-fixture.v1.json";
const OWNERSHIP = "manifests/ownership/wphx-312-49-wp-http-request-proxy-safety-oracle-fixture.v1.json";
const RECEIPT = "receipts/wp-core/wphx-312-49-wp-http-request-proxy-safety-oracle-fixture.v1.json";
...
function ownershipManifest(manifestSha) {
  return {
    ...
    manifest_id: "ownership:wp-core/wp-http-request-proxy-safety-oracle-fixture",
    issue: {
      id: ISSUE.id,
    ...
    unit: {
      ...
      name: "WP_Http request proxy/safety option behavior",
      area:
      ...
      public_contract:
        "This fixture executes copied WordPress 7.0 WP_Http request proxy and URL-safety option branches in isolated PHP CLI probes. It observes reject_unsafe_urls filtering, URL validation, bad-protocol stripping, redirect validation hook registration, proxy option/auth handoff, proxy bypass hosts, and pre_http_send_through_proxy overrides through a deterministic Requests boundary without claiming live Requests network I/O, real DNS/proxy/TLS behavior, transport execution, installed distribution behavior, or generated public PHP ownership."
    },
    ...
    verification: {
      oracle_commands: [
        "npm run wp:core:wphx-312-wp-http-request-proxy-safety-oracle-fixture",
        "npm run wp:core:wphx-312-wp-http-request-proxy-safety-oracle-fixture:check",
        "npm run receipts:validate",
        "npm run beads:validate"
      ],
      receipt_refs: ["receipt:wphx-312-49-wp-http-request-proxy-safety-oracle-fixture"],
...
async function main() {
  ...
  const manifest = {
    schema: "wphx.wp-core-wp-http-request-proxy-safety-oracle-fixture.v1",
  ...
  const receipt = {
    ...
    id: "receipt:wphx-312-49-wp-http-request-proxy-safety-oracle-fixture",
    issue: ISSUE,
    recorded_at: RECORDED_AT,
    artifacts: [
      { path: OUT, role: "WP_Http request proxy/safety oracle-source-mirror fixture manifest" },
      { path: OWNERSHIP, role: "ownership manifest for copied-oracle WP_Http request proxy/safety boundary" },
