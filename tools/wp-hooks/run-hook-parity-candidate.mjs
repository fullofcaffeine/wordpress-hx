...
function ownershipManifest(manifestSha, upstreamDigest) {
  return {
    ...
    notes:
      "WPHX-303 promotes the Haxe-authored hook decision model to parity candidate without claiming the public plugin.php/class-wp-hook.php shell is Haxe-owned. Native callback dispatch, reference semantics, globals, and reflection-visible PHP shell replacement remain owned by WPHX-304."
  };
}
...
const manifest = {
  ...
  validation_result: {
    ...
    public_shell_replacement_owner_issue: "WPHX-304"
  }
};
