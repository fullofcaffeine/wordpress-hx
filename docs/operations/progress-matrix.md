...
Source checkpoint: `WPHX-310 bounded domain closure`
...
| WordPress PHP runtime Haxe ownership | 40 | 32.5 | 13.0 | `WPHX-300` has verified vertical slices, first-party PHP manifest ownership/split closure, bounded WPHX-306 users/auth, WPHX-307 posts/query, WPHX-308 taxonomy/comment, WPHX-309 routing/template, and WPHX-310 theme/theme JSON/template hierarchy domain closures, but much of Core remains unported |
